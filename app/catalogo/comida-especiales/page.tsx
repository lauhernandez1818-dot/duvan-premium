...
import { comidasEspeciales, type ComidaEspecialItem } from '@/src/data/catalogo/comidaEspecial';
...
const pageSubtitle = 'Nuestras preparaciones estrella. Calidad gourmet para tu equipo.';

type Slide = { tipo: 'image' | 'video'; item: ComidaEspecialItem };

export default function ComidaEspecialesPage() {
