    ...
    <div className="min-h-screen bg-[#0d2159] overflow-x-hidden w-full max-w-[100vw] min-w-0">
      ...
      <section className="py-16 sm:py-24 xl:py-40 min-[1920px]:py-48 bg-gradient-to-b from-[#0d2159] via-[#0f172a] to-[#0d2159] relative overflow-hidden">
        ...
        <div className="container mx-auto px-3 sm:px-4 md:px-6 min-[800px]:px-6 xl:px-8 min-[1920px]:px-12 relative z-10 max-w-[100vw] min-w-0">
          <motion.div
            ...
            className="text-center mb-12 sm:mb-16 xl:mb-20 min-[1920px]:mb-24 min-w-0"
          >
          ...
          <div className="grid grid-cols-1 min-[800px]:grid-cols-2 gap-4 sm:gap-6 min-[800px]:gap-6 xl:gap-8 min-[1920px]:gap-10 max-w-4xl xl:max-w-5xl min-[1920px]:max-w-6xl mx-auto w-full min-w-0">
            {imagenes.map((imagen, index) => (
              ...
              >
                ...
                <div className="relative bg-gradient-to-br from-[#0f172a] to-[#0d2159] border border-white/10 rounded-2xl overflow-hidden group-hover:border-white/30 transition-all">
                  ...
                  <div className="p-6 bg-gradient-to-br from-[#0f172a] to-[#0d2159] border-t border-white/10">
      ...
      <ProfessionalModal
        ...
        items={imagenes.map(img => ({
          ...
          alt: img.alt,
          title: `Imagen ${img.id}`,
          description: "Inversiones Duvan - Instalaciones"
        }))}
        currentIndex={selectedImage ?? 0}
        onNext={nextImage}
        onPrev={prevImage}
        categoryLabel="Nuestra Galería"
