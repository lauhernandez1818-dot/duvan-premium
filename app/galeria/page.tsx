          ...
          <div className="grid grid-cols-1 min-[800px]:grid-cols-2 gap-4 sm:gap-6 min-[800px]:gap-6 xl:gap-8 min-[1920px]:gap-10 max-w-4xl xl:max-w-5xl min-[1920px]:max-w-6xl mx-auto w-full min-w-0">
            {imagenes.map((imagen, index) => (
              ...
              >
                ...
                <div className="relative bg-gradient-to-br from-[#0f172a] to-[#08142c] border border-white/10 rounded-2xl overflow-hidden group-hover:border-white/30 transition-all">
                  ...
                  <div className="p-6 bg-gradient-to-br from-[#0f172a] to-[#08142c] border-t border-white/10">
