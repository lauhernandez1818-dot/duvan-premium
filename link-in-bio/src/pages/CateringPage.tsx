    ...
    <div className="pt-14 pb-16 px-[var(--page-padding-x)]">
      <main className="w-full max-w-[min(460px,100%)] mx-auto">
        ...
        <motion.p
          ...
          className="text-xs text-amber-300/80 mt-8 mb-3"
        >
        ...
        <motion.div
          ...
          className="rounded-2xl border-2 border-amber-400/20 bg-gradient-to-b from-amber-950/30 to-amber-950/10 px-4 py-10 flex items-center justify-center"
        >
          <span className="text-sm text-amber-200/70">Esperando foto</span>
        </motion.div>
      </main>
    </div>
  );
